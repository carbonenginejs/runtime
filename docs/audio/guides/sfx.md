...
Choose the independent [effect policies](../reference/api.md#effect-policies)
when constructing the runtime. These are browser DSP adaptations, not native
Wwise equivalence. Exact record admission, parameter mappings, channel limits,
unsupported controls, and per-effect lifecycle qualifications live in the
routing reference:

- [Parametric EQ](../reference/wwise-resource-routing.md#source-local-effects-and-parametric-eq) and [Delay](../reference/wwise-resource-routing.md#delay).
- [Compressor and Peak Limiter](../reference/wwise-resource-routing.md#compressor-and-peak-limiter).
- [Flanger](../reference/wwise-resource-routing.md#flanger) and [Tremolo](../reference/wwise-resource-routing.md#tremolo).
- [Guitar Distortion](../reference/wwise-resource-routing.md#guitar-distortion) and the unsupported [Harmonizer](../reference/wwise-resource-routing.md#harmonizer).
- [Matrix Reverb](../reference/wwise-resource-routing.md#matrix-reverb) and [RoomVerb](../reference/wwise-resource-routing.md#roomverb).
