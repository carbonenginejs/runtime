...
`CjsAudioLibrary` is a small browser remote-acquisition client. It does not
...
const remote = new CjsAudioLibrary();
...
`CjsAudioLibrary` structurally implements:
...
- Runtime contract:
  `@carbonenginejs/runtime-audio/docs/concepts/audio-manager.md`
