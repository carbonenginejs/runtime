...
The Black reader uses the package-owned generated definition snapshot that
`src/resource/formats/black/core/blackDefinitions.js` imports, currently
`black-schema-v1-2026-09-19.json`. The Red format exposes the same catalog for
discovery, but its YAML reader currently accepts named fields without registry
enforcement. That snapshot was generated by tools-core revision `d8c20bb` from
the 2026-09-19 Carbon scan and landed in runtime revision `2c2b8c9f`, SHA-256
`0A4EBE699C9055C6132A41F6F709C2CC4BF80E928DC958DE13C1AF1F45F19A19`.

Dated snapshots are never edited in place; a new one is generated, and
tools-core's `--black-module` points `blackDefinitions.js` at the newest. The
previous snapshot, `black-schema-v1-2026-07-23.json` (runtime-resource revision
`6beda70`, SHA-256
`9234DD86DBB5EB3676EF060E383ADBCE8F073941E76A32865D3528DD5DA7B737`, generator
revision unrecorded), stays in the package and is no longer imported.
...
- `formats/cmf` gained a **binary CMF v1 writer** (2026-07-15,
  `src/resource/formats/cmf/core/writer.js`, `CjsCmfFormat.write`/`writeAsync` and
...
- `formats/cmf` also gained the **GR2 skeleton/animation converter**
  (2026-07-15, `src/resource/formats/cmf/core/gr2Anim.js`, applied automatically by
...
- `formats/ogg` gained a pure-JS **Ogg Vorbis PCM decoder** (2026-07-15,
  `src/resource/formats/ogg/core/{vorbis.js,imdct.js}`, `emit: "pcm"`/`"audio"`):
...
`src/resource/formats/wem/core/packedCodebooksAotuv603.js` (base64 module). It was
