...
The `resource` layer owns canonical `Tr2EffectRes`/`Tr2Shader` construction,
permutation selection, and caching, reading the compiled container directly. The `trinity` layer owns the mutable
