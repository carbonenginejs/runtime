...
Status: Evolving  
Scope: `@carbonenginejs/runtime/tools/ship-show-info`  
...
} from "@carbonenginejs/runtime/tools/ship-show-info/ui";
import "@carbonenginejs/runtime/tools/ship-show-info/ui.css";
```
...
`demo/ship-show-info/` uses composed tools-core data and the image
