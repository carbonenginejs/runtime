...
| [`./contracts`](../../../src/global/contracts/index.js) | Declares dependency-floor nominal obligations whose required base methods throw. | `CjsBackendCandidate`, `CjsConstantPayload`, `CjsFrameLifecycle`, `CjsInstancedMeshManager`, `ITr2BoundingBox`, `withITr2BoundingBox`, `ITr2RenderNode`, `withITr2RenderNode` |
| [`./blue`](../../../src/global/blue/index.js) | Ports of Carbon's blueexposure layer: facilities Blue provides to every subsystem rather than to one. | `CjsScriptCallback` |
