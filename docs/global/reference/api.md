...
| [`./contracts`](../../../src/global/contracts/index.js) | Declares dependency-floor nominal obligations whose required base methods throw. | `CjsBackendCandidate`, `CjsConstantPayload`, `ITr2BoundingBox`, `withITr2BoundingBox`, `ITr2RenderNode`, `withITr2RenderNode` |
| [`./blue`](../../../src/global/blue/index.js) | Ports of Carbon's blueexposure layer; includes enum registration and lookup. | `CjsScriptCallback`, `CjsBlueEnumRegistry`, `blue.enums` |
...
`CjsSchema` and `CjsModel` JSDoc, and the source-backed
