...
| [`./blue`](../../../src/global/blue/index.js) | Ports of Carbon's blueexposure layer; includes [enum registration and lookup](../blue-enums.md). | `CjsScriptCallback`, `CjsBlueEnumRegistry`, `blue.enums` |
