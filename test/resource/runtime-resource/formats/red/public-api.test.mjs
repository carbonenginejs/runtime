...
{
    const mod = await import("../../../../../npm/dist/resource/formats/red/index.js");
...
{
    const redGraph = await readFile(new URL("../../../../../npm/dist/resource/formats/red/core/redGraph.js", import.meta.url), "utf8");
