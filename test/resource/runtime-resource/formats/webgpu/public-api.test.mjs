...
import CjsWebgpuFormat, { CjsWebgpuFormat as NamedCjsWebgpuFormat } from "../../../../../src/resource/formats/webgpu/index.js";
...
{
    const mod = await import("../../../../../src/resource/formats/webgpu/index.js");
