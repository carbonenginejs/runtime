...
{
    const mod = await import("../../../../../npm/dist/resource/formats/black/index.js");
...
{
    const schema = await import("../../../../../npm/dist/resource/formats/black/core/blackSchema.js");
    const enums = await import("../../../../../npm/dist/resource/formats/black/core/blackEnums.js");
    const version = await import("../../../../../npm/dist/resource/formats/black/core/blackVersion.js");
...
test("bounded support probe recognizes Black magic without parsing the body", () =>
{
    ...
    assert.equal(CjsBlackFormat.is(bytes), true);
    assert.equal(CjsBlackFormat.is(bytes.subarray(1)), false);
    assert.equal(CjsBlackFormat.is(new Uint8Array([ 1, 2, 3 ])), false);
});
