...
test("EveConnector is maintained with one canonical ConnectorType enum", () =>
{
  ...
  assert.equal(
    existsSync(new URL("../../src/trinity/generated/eve/ui/EveConnector.js", import.meta.url)),
    false
  );
  assert.equal(
    existsSync(new URL("../../src/trinity/generated/eve/ui/enums.js", import.meta.url)),
    false
  );
