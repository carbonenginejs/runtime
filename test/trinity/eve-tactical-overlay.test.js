...
import { Tr2QuadRenderer, TriFrustum } from "../../npm/dist/trinity/core/index.js";
...
test("EveTacticalOverlay is maintained with scalar Carbon range fields", () =>
{
  ...
  assert.equal(
    existsSync(new URL("../../src/trinity/generated/eve/ui/EveTacticalOverlay.js", import.meta.url)),
    false
  );
  assert.deepEqual(
