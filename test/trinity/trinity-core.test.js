...
test("Tr2DirectInstanceData retains detached CPU bounds", () =>
{
  ...
  assertEquals(existsSync(new URL("../../src/trinity/generated/trinityCore/Tr2DirectInstanceData.js", import.meta.url)), false);
});
...
test("Tr2VisibilityResults keeps native events transient", () =>
{
  ...
  assertEquals(existsSync(new URL("../../src/trinity/generated/trinityCore/Tr2VisibilityResults.js", import.meta.url)), false);
});
...
test("dropped Blue and native scanner shapes stay quarantined", () =>
{
  ...
  const droppedReadme = readFileSync(new URL("../../src/trinity/dropped/README.md", import.meta.url), "utf8");
  for (const [family, names] of Object.entries(droppedByFamily))
  {
    for (const name of names)
    {
      assert.equal(existsSync(new URL(`../../src/trinity/generated/${family}/${name}.js`, import.meta.url)), false, name);
      assert.equal(existsSync(new URL(`../../src/trinity/dropped/${name}.js`, import.meta.url)), true, name);
  ...
  const barrels = Object.fromEntries(Object.keys(droppedByFamily).map(family => [
    family,
    readFileSync(new URL(`../../src/trinity/generated/${family}/index.js`, import.meta.url), "utf8")
  ]));
  for (const [family, names] of Object.entries(droppedByFamily))
  {
    for (const name of names)
  ...
  assert.equal(existsSync(new URL("../../src/trinity/generated/trinityCore/TriMatrix.js", import.meta.url)), false);
  assert.equal(CjsSchema.GetConstructor("TriMatrix"), null);
  assert.equal(existsSync(new URL("../../src/trinity/generated/trinityCore/Tr2GStateAnimation.js", import.meta.url)), false);
  assert.equal(existsSync(new URL("../../src/trinity/generated/trinityCore/Tr2GStateParameter.js", import.meta.url)), false);
  assert.equal(existsSync(new URL("../../src/trinity/generated/eve/socket/_className.js", import.meta.url)), false);
  assert.equal(existsSync(new URL("../../src/trinity/generated/include/ITr2InteriorLight.js", import.meta.url)), false);
});
