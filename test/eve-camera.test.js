...
test("EveCamera owns Carbon's scalar Blue distance and maintained tree", () =>
{
  ...
  assert.equal(existsSync(new URL("../src/eve/camera/EveCamera.js", import.meta.url)), true);
  assert.equal(existsSync(new URL("../src/generated/eve/EveCamera.js", import.meta.url)), false);
});
