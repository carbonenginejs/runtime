...
{
    const pending = [ path.join(packageRoot, "src") ];
    const files = [];
...
test("every runtime entry imports without touching browser capabilities", () =>
{
    const probe = spawnSync(process.execPath, [
        ...
        `
            ...
            const library = await import("./npm/dist/library/index.js");
            const builder = await import("./npm/dist/library-builder/index.js");
