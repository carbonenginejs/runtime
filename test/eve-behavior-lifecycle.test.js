...
test("lifecycle and tunnel records own Carbon defaults, enums, and maintained paths", () =>
{
  ...
  for (const path of [
    "../src/eve/child/behaviors/lifecycle/ProcessLifetime.js",
    "../src/eve/child/behaviors/lifecycle/ProcessLifetimeData.js",
    "../src/eve/child/behaviors/tunnels/SplineTunnelGroup.js",
    "../src/eve/child/behaviors/tunnels/SplineTunnel.js",
    "../src/eve/child/behaviors/tunnels/SplineTunnelPoint.js",
    "../src/eve/child/behaviors/enums.js"
  ])
  {
    assert.equal(existsSync(new URL(path, import.meta.url)), true, path);
  }
  for (const path of [
    "../src/generated/eve/child/behaviors/ProcessLifetime.js",
    "../src/generated/eve/child/behaviors/SplineTunnelGroup.js",
    "../src/generated/eve/child/behaviors/enums.js"
  ])
  {
