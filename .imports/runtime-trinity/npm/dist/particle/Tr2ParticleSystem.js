...
new class extends _identity {
  static [class Tr2ParticleSystem extends CjsModel {
    static {
      ({
    ...
    UpdateViewDependentData(frustum, worldTransform) {
      ...
      if (!frustum || !this.GetBoundingBox(_Tr2ParticleSystem.#boundsMin, _Tr2ParticleSystem.#boundsMax)) {
        return;
      }
      vec3.add(_Tr2ParticleSystem.#center, _Tr2ParticleSystem.#boundsMax, _Tr2ParticleSystem.#boundsMin);
      vec3.scale(_Tr2ParticleSystem.#center, _Tr2ParticleSystem.#center, 0.5);
      vec3.subtract(_Tr2ParticleSystem.#extent, _Tr2ParticleSystem.#boundsMax, _Tr2ParticleSystem.#boundsMin);
      vec3.scale(_Tr2ParticleSystem.#extent, _Tr2ParticleSystem.#extent, 0.5);
      const radius = Math.max(Math.abs(_Tr2ParticleSystem.#extent[0]), Math.abs(_Tr2ParticleSystem.#extent[1]), Math.abs(_Tr2ParticleSystem.#extent[2])) * Math.hypot(worldTransform[0], worldTransform[1], worldTransform[2]);
      vec3.transformMat4(_Tr2ParticleSystem.#center, _Tr2ParticleSystem.#center, worldTransform);
      vec4.set(_Tr2ParticleSystem.#boundingSphere, _Tr2ParticleSystem.#center[0], _Tr2ParticleSystem.#center[1], _Tr2ParticleSystem.#center[2], radius);
      if (!frustum.IsSphereVisible(_Tr2ParticleSystem.#boundingSphere)) {
  ...
  constructor() {
    super(_Tr2ParticleSystem), _initClass();
  }
}();
