...
class CjsVolumetricsExecutor {
  ...
  RenderVolumetrics(_renderer, _registry, _frustum, _sceneDepth, _froxelFog, _sunDirection, _depthSlices, _raytracingEnabled, _gpuResourcePool, _renderContext) {
  ...
  RenderFog(_renderer, _renderContext, _gpuResourcePool, _width, _height, _cascadedShadowMap, _raytracingGeometry, _shadowQuality, _sunDirection, _sunColor, _origin, _originShift, _view, _projection, _viewLast, _projectionLast) {
  ...
  RenderFogIntoReflectionMap(_renderer, _renderContext, _gpuResourcePool, _width, _height, _sunDirection, _sunColor, _origin, _view, _projection) {
...
export { CjsVolumetricsExecutor };
//# sourceMappingURL=CjsVolumetricsExecutor.js.map
