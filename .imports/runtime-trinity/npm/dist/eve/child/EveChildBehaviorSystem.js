...
import { createChildPerObjectRecords, inheritParentPerObjectData } from '../perObjectData/childPerObjectRecords.js';
...
new class extends _identity {
  static [class EveChildBehaviorSystem extends _EveChildTransform {
    static {
      ({
    ...
    UpdateAsyncronous(updateContext, params) {
      ...
      const inverse = _EveChildBehaviorSyst.#inverseScratch;
  ...
  constructor() {
    super(_EveChildBehaviorSyst), _initClass();
  }
}();
