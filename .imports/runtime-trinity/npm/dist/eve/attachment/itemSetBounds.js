 ...
 */
function CreateItemSetBoundingBoxes(staticBounds, boneBounds, skinned, items) {
 ...
 * @returns {box3} out
 */
function GetItemSetAabb(out, staticBounds, boneBounds, bones = null, boneCount = 0) {
...
export { CreateItemSetBoundingBoxes, GetItemSetAabb };
//# sourceMappingURL=itemSetBounds.js.map
