...
//
//   node scripts/generate_class_catalog.js                    every missing class
//   node scripts/generate_class_catalog.js --path src/eve     one subtree
...
const catalogRoot = path.join(root, "docs", "reference", "classes");
...
for (const file of files)
{
  ...
  if (relativeFile.startsWith("src/dropped/") || relativeFile.startsWith("src/generated/")) continue;
