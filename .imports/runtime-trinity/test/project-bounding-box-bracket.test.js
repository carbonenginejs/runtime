...
import { TriCurveSet } from "../npm/dist/curves/index.js";
import { Tr2ProjectBoundingBoxBracket } from "../npm/dist/ui/index.js";
import { Tr2SpriteObjectBase } from "../npm/dist/index.js";
...
test("Tr2ProjectBoundingBoxBracket is maintained with the rewritten Carbon defaults", () =>
{
  ...
  assert.equal(
    existsSync(new URL("../src/generated/trinityCore/Tr2ProjectBoundingBoxBracket.js", import.meta.url)),
    false
  );
});
