 ...
 * mode. Native Carbon uses this scene to render the avatar through managed
...
new class extends _identity {
  static [class WodBakingScene extends CjsModel {
    static {
      ({
        e: [_init_visualizeMethod, _init_extra_visualizeMethod, _init_Avatar, _init_extra_Avatar, _initProto],
