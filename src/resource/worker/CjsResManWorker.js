...
async function readFormat(payload) {
  ...
  // Caller-selected format modules are the worker protocol's explicit extension point.
  // This exact non-literal import site is recorded in the layering manifest.
