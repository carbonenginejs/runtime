...
{
  /**
   * Create one immutable format routing choice.
   * @param {typeof CjsFormat} Format Format facade constructor.
   * @param {object} [options] Reader, output, probe, and display-name options.
   */
