...
export class CjsAudioBackendSfxVoice
{
    ...
    })
    {
        ...
        this.getPlaybackRateAtVoicePitchCents =
        ...
        this.authoredOutputBusVolumeDb =
        ...
        this.getLowPassAtAdditionalPercent =
            descriptor.getLowPassAtAdditionalPercent;
        this.getHighPassAtAdditionalPercent =
    ...
    StartSourceEffects(at)
    {
        ...
        const sources = this.sourceEffectNodes.filter(node =>
