// Source: trinity/Eve/SpaceObject/Attachments/EveBoosterSet2.h:48
//
 ...
 * A booster set's vertex and pixel blocks.
 */
export class EveBoosterSetPerObjectData extends Tr2PerObjectData
{
  /** The vertex payload. */
  vs = null;
   ...
   * @returns {EveBoosterSetPerObjectData} The leased object.
   */
  static alloc(accumulator)
  {
    const record = new this();

    record.vs = accumulator.Alloc("EveBoosterSetVSData");
    record.ps = accumulator.Alloc("EveBoosterSetPSData");
