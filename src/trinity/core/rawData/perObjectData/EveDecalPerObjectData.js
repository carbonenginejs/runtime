// Source: trinity/Eve/SpaceObject/Attachments/EveSpaceObjectDecal.h:53
//
 ...
 * A decal's vertex and pixel blocks.
 */
export class EveDecalPerObjectData extends Tr2PerObjectData
{
  /** The vertex payload. */
  vs = null;
   ...
   * @returns {EveDecalPerObjectData} The leased object.
   */
  static alloc(accumulator)
  {
    const record = new this();

    record.vs = accumulator.Alloc("DecalVSPerObjectData");
    record.ps = accumulator.Alloc("DecalPSPerObjectData");
