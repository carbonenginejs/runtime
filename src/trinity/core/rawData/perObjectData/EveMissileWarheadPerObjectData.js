// Source: trinity/Eve/SpaceObject/EveMissileWarhead.h:194
//
 ...
 * A warhead's transform block.
 */
export class EveMissileWarheadPerObjectData extends Tr2PerObjectData
{
  /** The vertex payload. */
  vs = null;
   ...
   * @returns {EveMissileWarheadPerObjectData} The leased object.
   */
  static alloc(accumulator)
  {
    const record = new this();

    record.vs = accumulator.Alloc("EveMissileWarheadPerObjectData");
