// Source: trinity/Eve/SpaceObject/Children/EveChildSpherePin.h:16
//
 ...
 * The child sphere pin's block, bound to both registers.
 */
export class EveChildSpherePinPerObjectData extends Tr2PerObjectData
{
   ...
   * @returns {EveChildSpherePinPerObjectData} The leased object.
   */
  static alloc(accumulator)
  {
    const record = new this();

    record.data = accumulator.Alloc("EveChildSpherePinPerObjectData");
