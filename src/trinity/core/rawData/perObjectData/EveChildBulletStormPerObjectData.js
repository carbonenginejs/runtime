// Source: trinity/Eve/SpaceObject/Children/EveChildBulletStorm.h:20
//
...
//
// Carbon holds its fields inline and uploads them with a hand-computed size,
// `64 + 16 + 10 * 16`.
//
 ...
 * A bullet storm's transform, effect info and up to ten world-space target positions.
 */
export class EveChildBulletStormPerObjectData extends Tr2PerObjectData
{
  /** The vertex payload. */
  vs = null;
   ...
   * @returns {EveChildBulletStormPerObjectData} The leased object.
   */
  static alloc(accumulator)
  {
    const record = new this();

    record.vs = accumulator.Alloc("EveChildBulletStormPerObjectData");
