// Source: trinity/Eve/EveLensflare.cpp:22
//
 ...
 * A lensflare's block, bound to both per-object registers.
 */
export class EveLensflarePerObjectData extends Tr2PerObjectData
{
   ...
   * @returns {EveLensflarePerObjectData} The leased object.
   */
  static alloc(accumulator)
  {
    const record = new this();

    record.data = accumulator.Alloc("EveLensflarePerObjectData");
