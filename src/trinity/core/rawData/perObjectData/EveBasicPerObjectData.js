// Source: trinity/Eve/EveTransform.h:148
//
...
//
// Carbon holds three Matrix members inline rather than a named struct, and uploads
// the run of them.
//
 ...
 * The world, previous-world and inverse-world matrices every plain transform uploads.
 */
export class EveBasicPerObjectData extends Tr2PerObjectData
{
  /** The vertex payload. */
  vs = null;
   ...
   * @returns {EveBasicPerObjectData} The leased object.
   */
  static alloc(accumulator)
  {
    const record = new this();

    record.vs = accumulator.Alloc("EveBasicPerObjectData");
