// Source: trinity/Eve/SpaceObject/Children/EveChildBoosterSet.h:36
//
 ...
 * The child booster set's vertex and pixel blocks.
 */
export class EveChildBoosterSetPerObjectData extends Tr2PerObjectData
{
  /** The vertex payload. */
  vs = null;
   ...
   * @returns {EveChildBoosterSetPerObjectData} The leased object.
   */
  static alloc(accumulator)
  {
    const record = new this();

    record.vs = accumulator.Alloc("EveChildBoosterSetVSData");
    record.ps = accumulator.Alloc("EveChildBoosterSetPSData");
