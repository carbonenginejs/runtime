...
// The runtime resource layer already has it in `passUnitSignature` and `unit.sha256`.
...
// already has one from the runtime resource layer - and an unnamed pipeline is prepared
