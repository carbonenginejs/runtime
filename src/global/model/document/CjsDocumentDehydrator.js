...
{
    /** Serializes a runtime root graph into a normalized Carbon document. */
    Dehydrate(value, options = {})
    {
        return CjsDocumentDehydrator.dehydrate(value, options);
    }

    /** Walks a runtime graph and emits normalized nodes, roots, and references. */
    ...
    /** Serializes one schema-backed or portable value into document form. */
    ...
    /**
     * Serializes a source-shaped object without inventing a runtime class
     * identity.
     */
    ...
    /**
     * Reports whether a value carries source-shape metadata for neutral
     * serialization.
     */
