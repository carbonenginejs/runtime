 ...
 */
export async function RunCjsResourceWorkerOperation(operation, payload, context = {}) {
  switch (operation) {
 ...
 */
export function InstallCjsResourceWorker(scope = globalThis) {
  ...
  const onMessage = async event => {
    ...
    try {
      const result = await RunCjsResourceWorkerOperation(
        message.operation,
        message.payload,
 ...
 */
export function CollectCjsResourceWorkerTransferables(value) {
 ...
 */
export function SerializeCjsResourceWorkerError(value, operation = undefined) {
  return {
