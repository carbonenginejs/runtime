...
export class EveChildBehaviorSystem extends EveChildTransform
{
  ...
  @carbon.method
  @impl.adapted
  @impl.reason("Carbon carries m_vsData/m_psData pointers (cpp:465-466); the persistent VS/PS buffers are engine-owned, so the GPU-free record carries the object reference the engine serializer consumes (EveChildMesh precedent).")
