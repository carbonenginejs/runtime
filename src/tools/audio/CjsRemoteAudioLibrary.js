...
import { CjsFileIndexLibrary } from "../fileindex/CjsFileIndexLibrary.js";
 ...
 */
export class CjsRemoteAudioLibrary
{
    #fetch;
    ...
    } = {})
    {
        ...
        {
            throw new TypeError("CjsRemoteAudioLibrary fetch must be a function");
        }
        if (fileIndex !== null && !(fileIndex instanceof CjsFileIndexLibrary))
        {
            throw new TypeError(
                "CjsRemoteAudioLibrary fileIndex must be a CjsFileIndexLibrary",
            );
        }
    ...
    GetAudioIndexEntries()
    {
        ...
        {
            throw new Error(
                "CjsRemoteAudioLibrary requires a loaded file index for audio rows",
            );
        }
    ...
    } = {})
    {
        ...
        {
            throw new TypeError(
                "CjsRemoteAudioLibrary soundbanksInfo input is required",
            );
        }
