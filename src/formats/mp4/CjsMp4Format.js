...
export class CjsMp4Format
{
    ...
    {
        return readWithValues(input, normalizeValues(DEFAULT_VALUES, { inputType: "mp4", ...options }, FORMAT_NAME), "mp4");
    }
    ...
    {
        return inspectWithValues(input, normalizeValues(DEFAULT_VALUES, { inputType: "mp4", ...options }, FORMAT_NAME), "mp4");
    }
