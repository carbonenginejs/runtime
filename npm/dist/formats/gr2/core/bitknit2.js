...
function decompressBitKnit2(bytes, expandedSize) {
  ...
  const commandModels = [new FrequencyModel(300, 36), new FrequencyModel(300, 36), new FrequencyModel(300, 36), new FrequencyModel(300, 36)];
  const cacheRefModels = [new FrequencyModel(40, 0), new FrequencyModel(40, 0), new FrequencyModel(40, 0), new FrequencyModel(40, 0)];
...
export { decompressBitKnit2 };
//# sourceMappingURL=bitknit2.js.map
