...
class Dictionary {
  ...
  decompressBlock(dec, out, pos) {
    ...
    if (this.backrefSize > 0) {
      const size = this.backrefSize < 61 ? this.backrefSize + 1 : BACKREF_SIZES[this.backrefSize - 61],
 ...
 */
function decompressOodle1(bytes, expandedSize, {
  first16,
  first8
}) {
...
export { OODLE1_BACKREF_SIZES, OODLE1_OUTPUT_SLACK, OODLE1_PARAMETER_BYTES, OODLE1_STREAM_PADDING, decompressOodle1, readOodle1Parameters };
//# sourceMappingURL=oodle1.js.map
