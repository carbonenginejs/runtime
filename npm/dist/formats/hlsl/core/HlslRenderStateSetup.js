...
class HlslRenderStateSetup {
  ...
  */
  constructor(states = new Map()) {
    this.states = states instanceof Map ? new Map(states) : new Map(Object.entries(states || {}).map(([key, value]) => [Number(key), Number(value)]));
  }
  ...
  */
  get entries() {
    return Array.from(this.states.entries()).map(([key, value]) => ({
      key,
      value
    }));
  }
...
export { HlslRenderStateSetup };
//# sourceMappingURL=HlslRenderStateSetup.js.map
