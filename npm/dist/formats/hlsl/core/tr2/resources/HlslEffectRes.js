...
class HlslEffectRes {
  ...
  */
  DoLoad(source, options = {}) {
    ...
    try {
      ...
      const stream = new HlslReader(this.m_data, {
  ...
  #readCurrentHeader() {
    ...
    this.m_compilerVersion = new DataView(Uint8Array.from(reader.compilerVersion).buffer).getUint32(0, true);
  ...
  */
  GetShaderByIndex(index) {
    ...
    const ok = shader.GetEffect().Read(buffer, offset.size, this.m_version, this.m_stringTable, this.m_stringTableSize, this.sourcePath, {
  ...
  */
  toJSON() {
    return {
      ...
      offsets: this.m_offsets.map(entry => ({
        ...entry
      })),
...
export { HlslEffectRes };
//# sourceMappingURL=HlslEffectRes.js.map
