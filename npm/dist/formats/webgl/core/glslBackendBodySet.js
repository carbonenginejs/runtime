 ...
 */
function buildGlslBackendBodySet(input) {
  const {
    bodies,
    stages,
    shaders,
  ...
  for (const body of bodies) {
    ...
    const representativePermutationIndex = permutationIndexByPackageKey.get(body.key) ?? 0;
    if (body.error) {
...
export { buildGlslBackendBodySet };
//# sourceMappingURL=glslBackendBodySet.js.map
