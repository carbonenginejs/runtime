 ...
 */
class CjsFsd64SchemaAudioMetadata extends CjsFsd64SchemaReader {
  Read(bytes) {
...
function AssertCounts(bytes, decoded, size) {
  ...
  for (const section of SECTIONS) {
    ...
    if (actual !== expected) {
      const error = new Error(`Decoded ${actual} of ${expected} ${section.name} records from ${schemaPath}`);
...
export { CjsFsd64SchemaAudioMetadata };
//# sourceMappingURL=CjsFsd64SchemaAudioMetadata.js.map
