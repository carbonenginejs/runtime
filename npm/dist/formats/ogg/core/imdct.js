 ...
 */
function imdct(spectrum, output, n) {
  const n2 = n >> 1;
  const n4 = n >> 2;
  const n34 = n - n4;
 ...
 */
function vorbisWindowSlope(length) {
...
export { dctIv, imdct, vorbisWindowSlope };
//# sourceMappingURL=imdct.js.map
