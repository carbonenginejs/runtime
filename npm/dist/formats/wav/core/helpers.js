...
function canEmitWavPcm(metadata) {
  return metadata.dataOffset > 0 && [1, 3].includes(metadata.formatTag) && metadata.channels > 0 && metadata.sampleRate > 0 && isSupportedWavSampleWidth(metadata);
}
...
function channelLayoutFromMask(mask, channels) {
  const names = [[0x001, "front-left"], [0x002, "front-right"], [0x004, "front-center"], [0x008, "low-frequency"], [0x010, "back-left"], [0x020, "back-right"], [0x040, "front-left-of-center"], [0x080, "front-right-of-center"], [0x100, "back-center"], [0x200, "side-left"], [0x400, "side-right"], [0x800, "top-center"], [0x1000, "top-front-left"], [0x2000, "top-front-center"], [0x4000, "top-front-right"], [0x8000, "top-back-left"], [0x10000, "top-back-center"], [0x20000, "top-back-right"]];
