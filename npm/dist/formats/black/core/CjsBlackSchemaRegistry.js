...
class CjsBlackSchemaRegistry {
  ...
  static normalizeShape(schema) {
    ...
    const blackFieldSource = CjsBlackSchemaRegistry.isCompactFieldMap(schema.fields) ? CjsBlackSchemaRegistry.compactBlackFields(schema.fields) : black.fields || schema.blackFields || schema.fields || [];
    const blackFields = blackFieldSource.filter(item => item && typeof item === "object").map(item => CjsBlackSchemaRegistry.normalizeBlackField(item, fields));
    return {
      ...schema,
      className,
  ...
  static compactTypeDescriptor(type, spec) {
    ...
    switch (normalized) {
      case "boolean":
      case "bool":
        return CjsBlackSchemaRegistry.compactBlackType("BOOL", {
          kind: "boolean"
        });
      case "string":
        return CjsBlackSchemaRegistry.compactBlackType("STDSTRING", {
          kind: "string"
        });
      case "wstring":
        return CjsBlackSchemaRegistry.compactBlackType("STDWSTRING", {
          kind: "string"
        });
      case "path":
        return CjsBlackSchemaRegistry.compactBlackType("STDSTRING", {
      ...
      case "enum":
        return CjsBlackSchemaRegistry.compactBlackType("LONG", {
          kind: "enum"
        }, {
          signed: true
        });
      case "float":
        return CjsBlackSchemaRegistry.compactBlackType("FLOAT", {
          kind: "float32"
        });
      case "double":
        return CjsBlackSchemaRegistry.compactBlackType("DOUBLE", {
          kind: "float64"
        });
      case "int":
        return CjsBlackSchemaRegistry.compactBlackType("LONG", {
      ...
      case "uint":
        return CjsBlackSchemaRegistry.compactBlackType("ULONG", {
          kind: "uint32"
        }, {
          signed: false
        });
      case "int64":
        return CjsBlackSchemaRegistry.compactBlackType("INT64", {
          kind: "int64"
        }, {
          signed: true
        });
      case "uint64":
        return CjsBlackSchemaRegistry.compactBlackType("UINT64", {
          kind: "uint64"
        }, {
          signed: false
        });
      case "byte":
        return CjsBlackSchemaRegistry.compactBlackType("BYTE", {
          kind: "int8"
        }, {
          signed: true
        });
      ...
      case "short":
        return CjsBlackSchemaRegistry.compactBlackType("SHORT", {
          kind: "int16"
        }, {
          signed: true
        });
      ...
      case "binaryBlock":
        return CjsBlackSchemaRegistry.compactBlackType("BINARYBLOCK", {
          kind: "typedArray"
        });
      default:
        return CjsBlackSchemaRegistry.compactBlackType(null, {
          kind: normalized
        });
    }
  }
  ...
  static normalizeBlackField(field, sourceFields = []) {
    ...
    const cppName = field.cppName || CjsBlackSchemaRegistry.getNameRole(names, "cppName") || CjsBlackSchemaRegistry.getNameRole(names, "memberPath") || CjsBlackSchemaRegistry.getNameRole(names, "memberRoot") || null;
    ...
    const sourceField = sourceFields.find(item => item.name === fieldName || item.name === name || item.cppName === cppName || item.cppName === memberPath || item.cppName === memberRoot);
    return {
      ...field,
      names,
      name,
...
export { CjsBlackSchemaRegistry };
//# sourceMappingURL=CjsBlackSchemaRegistry.js.map
