...
const DECLARATION_OPCODES = Object.freeze(["dcl_global_flags", "dcl_resource", "dcl_unordered_access_view_structured", "dcl_input", "dcl_input", "dcl_input", "dcl_temps", "dcl_thread_group_shared_memory_structured", "dcl_thread_group"]);
const BODY_OPCODES = Object.freeze(["ld", "if", "ret", "endif", "imad", "ishl", "iadd", "imin", "imax", "ult", "if", "ld_structured", "store_structured", "endif", "iadd", "ult", "if", "iadd", "ld_structured", "store_structured", "endif", "sync", "mov", "loop", "ult", "breakc", "ushr", "mov", "loop", "ige", "breakc", "iadd", "and", "iadd", "ishl", "ieq", "ishl", "iadd", "iadd", "iadd", "iadd", "iadd", "movc", "ult", "if", "iadd", "ld_structured", "ld_structured", "lt", "if", "store_structured", "store_structured", "endif", "endif", "sync", "ishr", "endloop", "ishl", "endloop", "if", "ld_structured", "store_structured", "endif", "if", "iadd", "ld_structured", "store_structured", "endif", "ret"]);
const BODY_OPERANDS_SM50 = Object.freeze(["temp:0:x:0::none:default:uniform:4 | immediate32::::#3,#3,#3,#3:none:default:uniform:4 | resource:0:xyzw:0::none:default:uniform:4", "temp:0:x:0::none:default:uniform:4", "", "", "temp:0:y:0::none:default:uniform:4 | input_thread_group_id::x:::none:default:uniform:4 | immediate32::::#512:none:default:uniform:1 | input_thread_id_in_group::x:::none:default:uniform:4", "temp:0:z:0::none:default:uniform:4 | input_thread_group_id::x:::none:default:uniform:4 | immediate32::::#9:none:default:uniform:1", "temp:0:x:0::none:default:uniform:4 | temp:0:z:0::neg:default:uniform:4 | temp:0:x:0::none:default:uniform:4", "temp:0:x:0::none:default:uniform:4 | temp:0:x:0::none:default:uniform:4 | immediate32::::#512:none:default:uniform:1", "temp:0:x:0::none:default:uniform:4 | temp:0:x:0::none:default:uniform:4 | immediate32::::#0:none:default:uniform:1", "temp:0:z:0::none:default:uniform:4 | input_thread_id_in_group_flattened::x:::none:default:uniform:4 | temp:0:x:0::none:default:uniform:4", "temp:0:z:0::none:default:uniform:4", "temp:1:xy:1::none:default:uniform:4 | temp:0:y:0::none:default:uniform:4 | immediate32::::#0:none:default:uniform:1 | uav:0:xyxx:0::none:default:uniform:4", "thread_group_shared_memory:0:xy:0::none:default:uniform:4 | input_thread_id_in_group_flattened::x:::none:default:uniform:4 | immediate32::::#0:none:default:uniform:1 | temp:1:xyxx:1::none:default:uniform:4", "", "temp:0:w:0::none:default:uniform:4 | input_thread_id_in_group_flattened::x:::none:default:uniform:4 | immediate32::::#256:none:default:uniform:1", "temp:1:x:1::none:default:uniform:4 | temp:0:w:0::none:default:uniform:4 | temp:0:x:0::none:default:uniform:4", "temp:1:x:1::none:default:uniform:4", "temp:1:y:1::none:default:uniform:4 | temp:0:y:0::none:default:uniform:4 | immediate32::::#256:none:default:uniform:1", "temp:1:yz:1::none:default:uniform:4 | temp:1:y:1::none:default:uniform:4 | immediate32::::#0:none:default:uniform:1 | uav:0:xxyx:0::none:default:uniform:4", "thread_group_shared_memory:0:xy:0::none:default:uniform:4 | temp:0:w:0::none:default:uniform:4 | immediate32::::#0:none:default:uniform:1 | temp:1:yzyy:1::none:default:uniform:4", "", "", "temp:1:y:1::none:default:uniform:4 | immediate32::::#2:none:default:uniform:1", "", "temp:1:z:1::none:default:uniform:4 | immediate32::::#512:none:default:uniform:1 | temp:1:y:1::none:default:uniform:4", "temp:1:z:1::none:default:uniform:4", "temp:1:z:1::none:default:uniform:4 | temp:1:y:1::none:default:uniform:4 | immediate32::::#1:none:default:uniform:1", "temp:1:w:1::none:default:uniform:4 | temp:1:z:1::none:default:uniform:4", "", "temp:2:x:2::none:default:uniform:4 | immediate32::::#0:none:default:uniform:1 | temp:1:w:1::none:default:uniform:4", "temp:2:x:2::none:default:uniform:4", "temp:2:x:2::none:default:uniform:4 | temp:1:w:1::none:default:uniform:4 | immediate32::::#4294967295:none:default:uniform:1", "temp:2:x:2::none:default:uniform:4 | temp:2:x:2::none:default:uniform:4 | input_thread_id_in_group_flattened::x:::none:default:uniform:4", "temp:2:y:2::none:default:uniform:4 | temp:2:x:2::neg:default:uniform:4 | input_thread_id_in_group_flattened::x:::none:default:uniform:4", "temp:2:y:2::none:default:uniform:4 | temp:2:y:2::none:default:uniform:4 | immediate32::::#1:none:default:uniform:1", "temp:2:z:2::none:default:uniform:4 | temp:1:z:1::none:default:uniform:4 | temp:1:w:1::none:default:uniform:4", "temp:2:w:2::none:default:uniform:4 | temp:1:w:1::none:default:uniform:4 | immediate32::::#1:none:default:uniform:1", "temp:2:w:2::none:default:uniform:4 | temp:2:y:2::none:default:uniform:4 | temp:2:w:2::none:default:uniform:4", "temp:2:w:2::none:default:uniform:4 | temp:2:w:2::none:default:uniform:4 | temp:2:x:2::neg:default:uniform:4", "temp:2:w:2::none:default:uniform:4 | temp:2:w:2::none:default:uniform:4 | immediate32::::#4294967295:none:default:uniform:1", "temp:3:x:3::none:default:uniform:4 | temp:1:w:1::none:default:uniform:4 | temp:2:y:2::none:default:uniform:4", "temp:3:x:3::none:default:uniform:4 | temp:2:x:2::none:default:uniform:4 | temp:3:x:3::none:default:uniform:4", "temp:2:z:2::none:default:uniform:4 | temp:2:z:2::none:default:uniform:4 | temp:2:w:2::none:default:uniform:4 | temp:3:x:3::none:default:uniform:4", "temp:2:w:2::none:default:uniform:4 | temp:2:z:2::none:default:uniform:4 | temp:0:x:0::none:default:uniform:4", "temp:2:w:2::none:default:uniform:4", "temp:2:x:2::none:default:uniform:4 | temp:2:x:2::none:default:uniform:4 | temp:2:y:2::none:default:uniform:4", "temp:2:yw:2::none:default:uniform:4 | temp:2:x:2::none:default:uniform:4 | immediate32::::#0:none:default:uniform:1 | thread_group_shared_memory:0:xxxy:0::none:default:uniform:4", "temp:3:xy:3::none:default:uniform:4 | temp:2:z:2::none:default:uniform:4 | immediate32::::#0:none:default:uniform:1 | thread_group_shared_memory:0:xyxx:0::none:default:uniform:4", "temp:3:z:3::none:default:uniform:4 | temp:3:y:3::none:default:uniform:4 | temp:2:w:2::none:default:uniform:4", "temp:3:z:3::none:default:uniform:4", "thread_group_shared_memory:0:xy:0::none:default:uniform:4 | temp:2:x:2::none:default:uniform:4 | immediate32::::#0:none:default:uniform:1 | temp:3:xyxx:3::none:default:uniform:4", "thread_group_shared_memory:0:xy:0::none:default:uniform:4 | temp:2:z:2::none:default:uniform:4 | immediate32::::#0:none:default:uniform:1 | temp:2:ywyy:2::none:default:uniform:4", "", "", "", "temp:1:w:1::none:default:uniform:4 | temp:1:w:1::none:default:uniform:4 | immediate32::::#1:none:default:uniform:1", "", "temp:1:y:1::none:default:uniform:4 | temp:1:y:1::none:default:uniform:4 | immediate32::::#1:none:default:uniform:1", "", "temp:0:z:0::none:default:uniform:4", "temp:0:xz:0::none:default:uniform:4 | input_thread_id_in_group_flattened::x:::none:default:uniform:4 | immediate32::::#0:none:default:uniform:1 | thread_group_shared_memory:0:xxyx:0::none:default:uniform:4", "uav:0:xy:0::none:default:uniform:4 | temp:0:y:0::none:default:uniform:4 | immediate32::::#0:none:default:uniform:1 | temp:0:xzxx:0::none:default:uniform:4", "", "temp:1:x:1::none:default:uniform:4", "temp:0:x:0::none:default:uniform:4 | temp:0:y:0::none:default:uniform:4 | immediate32::::#256:none:default:uniform:1", "temp:0:yz:0::none:default:uniform:4 | temp:0:w:0::none:default:uniform:4 | immediate32::::#0:none:default:uniform:1 | thread_group_shared_memory:0:xxyx:0::none:default:uniform:4", "uav:0:xy:0::none:default:uniform:4 | temp:0:x:0::none:default:uniform:4 | immediate32::::#0:none:default:uniform:1 | temp:0:yzyy:0::none:default:uniform:4", "", ""]);
const BODY_OPERANDS_SM51 = Object.freeze(BODY_OPERANDS_SM50.map(signature => signature.replaceAll("resource:0:xyzw:0::", "resource:0:xyzw:0,0::").replaceAll("uav:0:xyxx:0::", "uav:0:xyxx:0,0::").replaceAll("uav:0:xxyx:0::", "uav:0:xxyx:0,0::").replaceAll("uav:0:xy:0::", "uav:0:xy:0,0::")));
...
function operandSignature(operand) {
  ...
  return [operand.typeName, Number.isInteger(operand.registerIndex) ? operand.registerIndex : "", operand.mask || operand.swizzle || operand.selected || "", index, immediate, operand.modifierName ?? "none", operand.minPrecisionName ?? "default", operand.nonUniform === true ? "nonuniform" : "uniform", Number.isInteger(operand.componentCount) ? operand.componentCount : ""].join(":");
}
...
function validateCanonicalIndices(operand, context) {
  for (const [index, entry] of (operand.indices || []).entries()) {
    if (entry?.dimension !== index || entry.representation !== 0 || entry.relative !== null || entry.values?.length !== 1 || !Number.isInteger(entry.values[0]) || entry.values[0] < 0) {
      throw new Error(`WGSL sort ${context} has non-canonical index metadata`);
    }
  }
}
function validateCommonOperand(operand, context) {
  if (!operand || !["none", "neg"].includes(operand.modifierName ?? "none") || (operand.minPrecisionName ?? "default") !== "default" || operand.nonUniform === true) {
...
function validateDeclarationOperand(operand, {
  ...
  if ((operand.modifierName ?? "none") !== "none" || operand.typeName !== typeName || operand.registerIndex !== registerIndex || operand.componentCount !== componentCount || (operand.mask || operand.swizzle || operand.selected || "") !== selector || operand.indices?.length !== indices.length || indices.some((value, index) => operand.indices[index].values[0] !== value) || operand.immediateValues?.length) {
 ...
 */
function isSortComputeProfile(program) {
  return program?.stage === "compute" && program.declarations?.length === DECLARATION_OPCODES.length && program.instructions?.length === BODY_OPCODES.length && DECLARATION_OPCODES.every((opcodeName, index) => program.declarations[index]?.opcodeName === opcodeName);
}
function validateDeclarations(program) {
  ...
  const [global, input, output, flattenedId, groupId, localId, temps, shared, group] = program.declarations;
  ...
  if (input.data?.registerIndex !== 0 || input.data.resourceDimension !== 1 || input.data.resourceDimensionName !== "buffer" || input.data.sampleCount !== 0 || input.data.returnType?.returnTypes?.length !== 4 || input.data.returnType.returnTypes.some(entry => entry !== 4) || input.data.returnType?.returnTypeNames?.length !== 4 || input.data.returnType.returnTypeNames.some(entry => entry !== "uint") || input.operands?.length !== 1) {
  ...
  if (output.data?.registerIndex !== 0 || output.data.structureStride !== 8 || output.data.globallyCoherent !== false || output.operands?.length !== 1) {
  ...
  if (shared.data?.registerIndex !== 0 || shared.data.structureStride !== 8 || shared.data.structureCount !== 512 || shared.operands?.length !== 1) {
  ...
  if (group.data?.threadGroupX !== 256 || group.data?.threadGroupY !== 1 || group.data?.threadGroupZ !== 1 || group.operands?.length) {
  ...
  } else if (input.data.bindingModel || input.data.bindingRange || output.data.bindingModel || output.data.bindingRange) {
...
function validExtensions(program, instruction) {
  ...
  if (instruction.index === 0) {
    return extensions.length === 2 && extensions[0]?.token === 2147483714 && extensions[0].type === 2 && extensions[0]?.typeName === "resource_dimension" && extensions[0].resourceDimension === 1 && extensions[0].resourceDimensionName === "buffer" && extensions[0].structureStride === 0 && extensions[1]?.token === 1118467 && extensions[1].type === 3 && extensions[1]?.typeName === "resource_return_type" && extensions[1].resourceReturnTypes?.length === 4 && extensions[1].resourceReturnTypes.every(entry => entry === 4);
  }
  if ([11, 18].includes(instruction.index)) {
    return extensions.length === 2 && extensions[0]?.token === 2147500802 && extensions[0].type === 2 && extensions[0]?.typeName === "resource_dimension" && extensions[0].resourceDimension === 12 && extensions[0].resourceDimensionName === "structured_buffer" && extensions[0].structureStride === 8 && extensions[1]?.token === 1677699 && extensions[1].type === 3 && extensions[1]?.typeName === "resource_return_type" && extensions[1].resourceReturnTypes?.length === 4 && extensions[1].resourceReturnTypes.every(entry => entry === 6);
  }
  return extensions.length === 0;
}
function valueReadSites(program, valueId) {
  return program.instructions.filter(instruction => instruction.dataflow.reads.some(read => read.refs.some(ref => ref.valueId === valueId))).map(instruction => instruction.index);
}
function validateLoopMerge(program, plans, values, {
  ...
  if (loop?.kind !== "loop" || loop.merges.length !== 1 || merge.id !== mergeId || merge.type !== "u32" || values.get(mergeId)?.register !== register || values.get(mergeId)?.writeMask !== mask || values.get(mergeId)?.blockId !== blockId || merge.entryIncoming.valueId !== entryValueId || entry?.origin !== "instruction-write" || entry.instructionIndex !== entryInstruction || merge.backedgeIncoming.valueId !== backedgeValueId || backedge?.origin !== "instruction-write" || backedge.instructionIndex !== backedgeInstruction || JSON.stringify(valueReadSites(program, mergeId)) !== JSON.stringify(reads) || loop.exitMerges.length || loop.exitEdges.size) {
    throw new Error(`WGSL sort compute requires the canonical scalar loop merge at ${start}`);
  }
}
function validateBody(program) {
  const expectedOperands = program.shaderModel.minor === 0 ? BODY_OPERANDS_SM50 : BODY_OPERANDS_SM51;
  if (program.instructions?.length !== BODY_OPCODES.length || BODY_OPCODES.some((opcodeName, index) => program.instructions[index]?.opcodeName !== opcodeName || instructionOperandSignature(program.instructions[index]) !== expectedOperands[index])) {
  ...
  for (const [index, instruction] of program.instructions.entries()) {
    const expectedTest = zeroCondition.has(index) ? "zero" : nonzeroCondition.has(index) ? "nonzero" : null;
    if (instruction.index !== index || index > 0 && instruction.dxbcOffset <= program.instructions[index - 1].dxbcOffset || instruction.controlKind !== (CONTROL_KIND[instruction.opcodeName] || null) || instruction.testBoolean !== expectedTest || instruction.saturate || instruction.preciseMask !== "" || instruction.tailTokens?.length || !validExtensions(program, instruction) || instruction.opcodeName === "sync" && (instruction.syncFlags !== 3 || JSON.stringify(instruction.syncFlagNames) !== JSON.stringify(["threads_in_group", "thread_group_shared_memory"]))) {
  ...
  if (program.blocks.length !== 31 || program.controlFlow.edgeCount !== 38 || program.controlFlow.regions.length !== 9 || program.values.length !== 74 || originCounts["instruction-write"] !== 39 || originCounts["undefined-register"] !== 12 || originCounts["program-input"] !== 3 || originCounts["control-flow-merge"] !== 20) {
  ...
  if (plans.size !== 9 || SELECTION_STARTS.some(start => plans.get(start)?.kind !== "selection" || plans.get(start).hasElse || plans.get(start).merges.length)) {
  ...
  if (deadMerge?.origin !== "control-flow-merge" || deadMerge.register !== "temp[0]" || deadMerge.writeMask !== "z" || deadMerge.blockId !== "block26" || program.instructions.some(instruction => instruction.dataflow.reads.some(read => read.refs.some(ref => ref.valueId === "value212")))) {
    throw new Error("WGSL sort compute requires its canonical unobservable final merge");
  }
}
function validateBindings(bindings) {
  const expected = [["sampled-resource", "t0", "array<u32>", null, "read-only-storage", 4], ["storage-resource", "u0", "array<u32>", 8, "storage", 8]];
  if (bindings.length !== expected.length || expected.some(([kind, symbol, type, stride, bufferType, minSize], index) => {
    const binding = bindings[index];
    return binding?.resourceKind !== kind || binding.registerIndex !== 0 || binding.registerSpace !== 0 || binding.generatedSymbol !== symbol || binding.type !== type || (binding.structureStride ?? null) !== stride || binding.buffer?.type !== bufferType || binding.buffer.hasDynamicOffset !== false || binding.buffer.minBindingSize !== minSize;
  })) {
...
function rawSourcePart(instruction, operand, component) {
  ...
  if (operand.typeName === "temp") {
    if (operand.registerIndex === 1 && component === "y" && [24, 26, 57].includes(instruction.index)) {
      code = "merge_width";
    } else if (operand.registerIndex === 1 && component === "z" && [27, 35].includes(instruction.index)) {
      code = "half_width";
    } else if (operand.registerIndex === 1 && component === "w" && [29, 31, 35, 36, 40, 55].includes(instruction.index)) {
      code = "stride";
    } else {
      code = `r${operand.registerIndex}.${component}`;
    }
  } else if (["input_thread_id_in_group", "input_thread_id_in_group_flattened"].includes(operand.typeName)) {
    ...
    const sourceIndex = operand.immediateValues.length === 1 ? 0 : COMPONENTS.indexOf(component);
...
function sourceParts(instruction, operandIndex, active) {
  ...
  return selectedComponents(operand, active).map(component => rawSourcePart(instruction, operand, component));
}
function assignment(instruction, destination, parts) {
  const type = destination.mask.length === 1 ? "u32" : `vec${destination.mask.length}<u32>`;
  return {
...
function typedLoad(instruction, binding) {
  ...
  return assignment(instruction, instruction.operands[0], [`select(0u, ${binding.generatedSymbol}[min(${address}, ${length} - 1u)], ${address} < ${length})`]);
}
function structuredLoad(instruction, binding) {
  ...
  if (resource.typeName === "thread_group_shared_memory") {
    const parts = resourceComponents.map(component => `g0[((${address}) * 2u) + ${COMPONENTS.indexOf(component)}u]`);
...
function aluStatement(instruction) {
    ...
    case "imin":
      {
        ...
        parts = left.map((part, index) => `bitcast<u32>(${intrinsic}(bitcast<i32>(${part}), bitcast<i32>(${right[index]})))`);
        break;
      }
    case "ult":
      {
        const left = source(1);
        const right = source(2);
        parts = left.map((part, index) => `select(0u, 0xffffffffu, ${part} < ${right[index]})`);
        break;
      }
    case "ige":
      {
        const left = source(1);
        const right = source(2);
        parts = left.map((part, index) => `select(0u, 0xffffffffu, bitcast<i32>(${part}) >= bitcast<i32>(${right[index]}))`);
        break;
      }
    case "ieq":
      {
    ...
    case "lt":
      {
        const left = source(1);
        const right = source(2);
        parts = left.map((part, index) => `select(0u, 0xffffffffu, bitcast<f32>(${part}) < bitcast<f32>(${right[index]}))`);
        break;
      }
    case "ishr":
      {
        const left = source(1);
        const right = source(2);
        parts = left.map((part, index) => `bitcast<u32>(bitcast<i32>(${part}) >> ${right[index]})`);
        break;
      }
    case "movc":
      {
        ...
        parts = condition.map((part, index) => `select(${whenFalse[index]}, ${whenTrue[index]}, ${part} != 0u)`);
        break;
      }
    default:
  ...
  if (instruction.index === 55) return {
    ...statement,
    name: "stride"
  };
  if (instruction.index === 57) return {
    ...statement,
    name: "merge_width"
  };
  return statement;
...
function binding(bindings, resourceKind) {
  return bindings.find(entry => entry.resourceKind === resourceKind && entry.registerIndex === 0 && entry.registerSpace === 0);
}
 ...
 */
function lowerSortComputeProgram(program, options = {}) {
...
export { isSortComputeProfile, lowerSortComputeProgram };
//# sourceMappingURL=lowerSortComputeProgram.js.map
