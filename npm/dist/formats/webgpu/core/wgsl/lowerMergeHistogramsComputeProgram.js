...
const DECLARATION_OPCODES = Object.freeze(["dcl_global_flags", "dcl_constant_buffer", "dcl_resource", "dcl_unordered_access_view_typed", "dcl_input", "dcl_input", "dcl_temps", "dcl_thread_group_shared_memory_structured", "dcl_thread_group"]);
const BODY_OPCODES = Object.freeze(["ult", "if", "store_structured", "endif", "sync", "ftou", "imul", "ult", "if", "ishl", "ushr", "mov", "mov", "mov", "loop", "uge", "breakc", "ushr", "iadd", "ld", "atomic_iadd", "iadd", "atomic_iadd", "iadd", "atomic_iadd", "atomic_iadd", "iadd", "endloop", "endif", "sync", "if", "ld_structured", "atomic_iadd", "endif", "ret"]);
const BODY_OPERANDS_SM50 = Object.freeze(["temp:0:x:0::none:default:uniform:4 | input_thread_id_in_group::x:::none:default:uniform:4 | immediate32::::#64:none:default:uniform:1", "temp:0:x:0::none:default:uniform:4", "thread_group_shared_memory:0:x:0::none:default:uniform:4 | input_thread_id_in_group::x:::none:default:uniform:4 | immediate32::::#0:none:default:uniform:1 | immediate32::::#0:none:default:uniform:1", "", "", "temp:0:yz:0::none:default:uniform:4 | constant_buffer:0:xxyx:0,0::none:default:uniform:4", "null:::::none:default:uniform:0 | temp:0:y:0::none:default:uniform:4 | temp:0:z:0::none:default:uniform:4 | temp:0:y:0::none:default:uniform:4", "temp:0:y:0::none:default:uniform:4 | input_thread_id::x:::none:default:uniform:4 | temp:0:y:0::none:default:uniform:4", "temp:0:y:0::none:default:uniform:4", "temp:0:y:0::none:default:uniform:4 | input_thread_id::x:::none:default:uniform:4 | immediate32::::#6:none:default:uniform:1", "temp:0:y:0::none:default:uniform:4 | temp:0:y:0::none:default:uniform:4 | immediate32::::#2:none:default:uniform:1", "temp:1:z:1::none:default:uniform:4 | immediate32::::#0:none:default:uniform:1", "temp:2:yw:2::none:default:uniform:4 | immediate32::::#0,#0,#0,#0:none:default:uniform:4", "temp:2:x:2::none:default:uniform:4 | immediate32::::#0:none:default:uniform:1", "", "temp:0:z:0::none:default:uniform:4 | temp:2:x:2::none:default:uniform:4 | immediate32::::#64:none:default:uniform:1", "temp:0:z:0::none:default:uniform:4", "temp:0:z:0::none:default:uniform:4 | temp:2:x:2::none:default:uniform:4 | immediate32::::#2:none:default:uniform:1", "temp:0:z:0::none:default:uniform:4 | temp:0:z:0::none:default:uniform:4 | temp:0:y:0::none:default:uniform:4", "temp:3:xyzw:3::none:default:uniform:4 | temp:0:zzzz:0::none:default:uniform:4 | resource:0:xyzw:0::none:default:uniform:4", "thread_group_shared_memory:0::0::none:default:uniform:0 | temp:2:xyxx:2::none:default:uniform:4 | temp:3:x:3::none:default:uniform:4", "temp:1:xy:1::none:default:uniform:4 | temp:2:xxxx:2::none:default:uniform:4 | immediate32::::#1,#3,#0,#0:none:default:uniform:4", "thread_group_shared_memory:0::0::none:default:uniform:0 | temp:1:xzxx:1::none:default:uniform:4 | temp:3:y:3::none:default:uniform:4", "temp:2:z:2::none:default:uniform:4 | temp:2:x:2::none:default:uniform:4 | immediate32::::#2:none:default:uniform:1", "thread_group_shared_memory:0::0::none:default:uniform:0 | temp:2:zwzz:2::none:default:uniform:4 | temp:3:z:3::none:default:uniform:4", "thread_group_shared_memory:0::0::none:default:uniform:0 | temp:1:yzyy:1::none:default:uniform:4 | temp:3:w:3::none:default:uniform:4", "temp:2:x:2::none:default:uniform:4 | temp:2:x:2::none:default:uniform:4 | immediate32::::#4:none:default:uniform:1", "", "", "", "temp:0:x:0::none:default:uniform:4", "temp:0:x:0::none:default:uniform:4 | input_thread_id_in_group::x:::none:default:uniform:4 | immediate32::::#0:none:default:uniform:1 | thread_group_shared_memory:0:xxxx:0::none:default:uniform:4", "uav:0::0::none:default:uniform:0 | input_thread_id_in_group::x:::none:default:uniform:4 | temp:0:x:0::none:default:uniform:4", "", ""]);
const BODY_OPERANDS_SM51 = Object.freeze(BODY_OPERANDS_SM50.map(signature => signature.replaceAll("constant_buffer:0:xxyx:0,0::", "constant_buffer:0:xxyx:0,0,0::").replaceAll("resource:0:xyzw:0::", "resource:0:xyzw:0,0::").replaceAll("uav:0::0::", "uav:0::0,0::")));
...
function validateAnalysisMetadata(program) {
  ...
  if (JSON.stringify(analysisSnapshot(program)) !== JSON.stringify(analysisSnapshot(rebuilt))) {
    throw new Error("WGSL merge-histograms compute CFG, SSA, or type metadata is inconsistent");
  }
}
...
function validateCanonicalIndices(operand, context) {
  for (const [index, entry] of (operand.indices || []).entries()) {
    if (entry?.dimension !== index || entry.representation !== 0 || entry.relative !== null || entry.values?.length !== 1 || !Number.isInteger(entry.values[0]) || entry.values[0] < 0) {
      throw new Error(`WGSL merge-histograms ${context} has non-canonical index metadata`);
    }
  }
}
function validateCommonOperand(operand, context) {
  if (!operand || (operand.modifierName ?? "none") !== "none" || (operand.minPrecisionName ?? "default") !== "default" || operand.nonUniform === true) {
    throw new Error(`WGSL merge-histograms ${context} has unsupported operand modifiers`);
  }
...
function validateSm51Range(data, context) {
  ...
  if (data?.bindingModel !== "sm5.1-range" || range?.bindingModel !== "sm5.1-range" || range.rangeId !== 0 || range.lowerBound !== 0 || range.upperBound !== 0 || range.unbounded !== false || range.registerCount !== 1 || range.registerSpace !== 0) {
    throw new Error(`WGSL merge-histograms ${context} requires one finite SM5.1 range`);
  }
}
function validateDeclarationOperand(operand, {
  ...
  if (operand.typeName !== typeName || operand.registerIndex !== registerIndex || operand.componentCount !== componentCount || (operand.mask || operand.swizzle || operand.selected || "") !== selector || operand.indices?.length !== indices.length || indices.some((value, index) => operand.indices[index].values[0] !== value) || operand.immediateValues?.length || operand.resourceReference !== undefined && operand.resourceReference !== null) {
...
function validateBuiltinDeclaration(declaration, typeName, operandType, componentCount, selector) {
  ...
  if (declaration.data?.registerIndex !== null || declaration.data.operandType !== operandType || declaration.data.operandTypeName !== typeName || declaration.operands.length !== 1) {
    throw new Error(`WGSL merge-histograms compute requires exactly ${typeName}.${selector}`);
  }
}
 ...
 */
function isMergeHistogramsComputeProfile(program) {
...
function validateTypedUintBuffer(declaration, kind, minor) {
  ...
  if (data?.registerIndex !== 0 || data.resourceDimension !== 1 || data.resourceDimensionName !== "buffer" || kind === "resource" && data.sampleCount !== 0 || kind === "uav" && data.globallyCoherent !== false || data.returnType?.returnTypes?.length !== 4 || data.returnType.returnTypes.some(entry => entry !== 4) || data.returnType?.returnTypeNames?.length !== 4 || data.returnType.returnTypeNames.some(entry => entry !== "uint") || declaration.operands?.length !== 1) {
    throw new Error(`WGSL merge-histograms compute requires typed uint Buffer ${label}`);
  }
...
function validateDeclarations(program) {
  ...
  if (program?.format !== "CJS_SHADER_IR" || program.formatVersion !== 1 || program.stage !== "compute" || program.shaderModel?.major !== 5 || ![0, 1].includes(minor)) {
    throw new TypeError("WGSL merge-histograms compute profile requires CJS SM5.0 or finite-range SM5.1 compute IR");
  }
  if (!isMergeHistogramsComputeProfile(program)) {
    throw new Error("WGSL merge-histograms compute declaration shape is not supported");
  }
  if (program.declarations.some(declaration => declaration.tailTokens?.length)) {
    throw new Error("WGSL merge-histograms compute declarations must not contain trailing payload words");
  }
  if ((program.signatures?.input || []).length || (program.signatures?.output || []).length || (program.signatures?.patch || []).length || program.immediateConstantBuffer || program.constTables) {
    throw new Error("WGSL merge-histograms compute profile does not support signatures or constant tables");
  }
  requireRefactoringAllowed(program, "merge-histograms compute");
  const [global, constants, input, output, localId, dispatchId, temps, shared, group] = program.declarations;
  if (global.data?.globalFlags !== 1 << 11 || global.data.refactoringAllowed !== true || global.operands?.length) {
    throw new Error("WGSL merge-histograms compute requires only the refactoring-allowed global flag");
  }
  if (constants.data?.accessPattern !== "immediate_indexed" || constants.data.registerIndex !== 0 || constants.data.sizeInVec4 !== 1 || constants.operands?.length !== 1) {
    throw new Error("WGSL merge-histograms compute requires immediate one-row cb0");
  }
  ...
  if (temps.data?.tempCount !== 4 || temps.operands?.length) {
    throw new Error("WGSL merge-histograms compute requires exactly four temps");
  }
  if (shared.data?.registerIndex !== 0 || shared.data.structureStride !== 4 || shared.data.structureCount !== 64 || shared.operands?.length !== 1) {
    throw new Error("WGSL merge-histograms compute requires g0 with stride 4 and 64 records");
  }
  ...
  if (group.data?.threadGroupX !== 256 || group.data?.threadGroupY !== 1 || group.data?.threadGroupZ !== 1 || group.operands?.length) {
    throw new Error("WGSL merge-histograms compute requires dcl_thread_group 256,1,1");
  }
  if (minor === 1) {
    ...
    throw new Error("WGSL merge-histograms SM5.0 declarations must use register bindings");
  }
}
function validateBodyReference(program, instruction, operand, operandIndex) {
  ...
  if (program.shaderModel.minor === 0) {
    if (operand.resourceReference !== undefined && operand.resourceReference !== null) {
      throw new Error(`WGSL merge-histograms ${context} has unexpected SM5.1 reference metadata`);
    }
    return;
  }
  ...
  if (["resource", "uav"].includes(operand.typeName)) {
    if (reference?.bindingModel !== "sm5.1-range" || reference.rangeId !== 0 || reference.nonUniform !== false || !isCanonicalIndex(reference.absoluteIndex, 1, 0) || reference.bufferIndex !== null || reference.vectorOffset !== null) {
      throw new Error(`WGSL merge-histograms ${context} has an invalid SM5.1 resource reference`);
    }
    ...
    if (reference?.bindingModel !== "sm5.1-range" || reference.rangeId !== 0 || reference.nonUniform !== false || reference.absoluteIndex !== null || !isCanonicalIndex(reference.bufferIndex, 1, 0) || !isCanonicalIndex(reference.vectorOffset, 2, 0)) {
      throw new Error(`WGSL merge-histograms ${context} has an invalid SM5.1 constant-buffer reference`);
    }
  } else if (reference !== undefined && reference !== null) {
    throw new Error(`WGSL merge-histograms ${context} has unexpected resource reference metadata`);
  }
}
...
function validateBody(program) {
  ...
  if (program.instructions?.length !== BODY_OPCODES.length || BODY_OPCODES.some((opcodeName, index) => program.instructions[index]?.opcodeName !== opcodeName || instructionOperandSignature(program.instructions[index]) !== expectedOperands[index])) {
    throw new Error("WGSL merge-histograms compute requires the exact bounded body opcode, operand, and modifier sequence");
  }
  for (const [index, instruction] of program.instructions.entries()) {
    ...
    if (instruction.index !== index || index > 0 && instruction.dxbcOffset <= program.instructions[index - 1].dxbcOffset || instruction.controlKind !== (CONTROL_KIND[instruction.opcodeName] || null) || instruction.testBoolean !== (conditional ? "nonzero" : null) || instruction.saturate || instruction.preciseMask !== "" || instruction.tailTokens?.length || !validExtensions(program, instruction) || (sync ? instruction.syncFlags !== 3 || JSON.stringify(instruction.syncFlagNames) !== JSON.stringify(["threads_in_group", "thread_group_shared_memory"]) : instruction.syncFlags !== undefined || instruction.syncFlagNames !== undefined)) {
      throw new Error(`WGSL merge-histograms instruction ${index} has inconsistent envelope metadata`);
    }
  ...
  if (program.blocks.length !== 14 || program.controlFlow.edgeCount !== 17 || program.controlFlow.regions.length !== 4 || program.controlFlow.unreachableBlockIds.length || program.values.length !== 30 || originCounts["instruction-write"] !== 17 || originCounts["undefined-register"] !== 8 || originCounts["program-input"] !== 2 || originCounts["control-flow-merge"] !== 3) {
    throw new Error("WGSL merge-histograms compute requires the canonical CFG and register-value shape");
  }
  ...
  for (const instruction of program.instructions) {
    for (const ref of instruction.dataflow.reads.flatMap(read => read.refs)) {
      if (values.get(ref.valueId)?.origin === "undefined-register") {
        throw new Error(`WGSL merge-histograms instruction ${instruction.index} reads undefined register data`);
      }
    }
  }
  const plans = buildSelectionPlans(program, "merge-histograms compute");
  if (plans.size !== 4 || SELECTION_STARTS.some(start => plans.get(start)?.kind !== "selection" || plans.get(start).hasElse || plans.get(start).merges.length)) {
    throw new Error("WGSL merge-histograms compute requires the canonical no-else selections");
  }
  const loop = plans.get(14);
  const merge = loop?.merges?.[0];
  if (loop?.kind !== "loop" || loop.preheaderBlockId !== "block4" || loop.backedgeBlockId !== "block8" || loop.merges.length !== 1 || merge.id !== "value68" || merge.type !== "u32" || merge.entryIncoming?.blockId !== "block4" || merge.entryIncoming?.valueId !== "value25" || merge.entryIncoming?.component !== "x" || merge.backedgeIncoming?.valueId !== "value44" || merge.backedgeIncoming?.component !== "x" || loop.exitMerges.length || loop.exitEdges.size) {
    throw new Error("WGSL merge-histograms compute requires the canonical four-bin loop merge");
  }
}
function validateBindings(bindings) {
  const expected = [["uniform-buffer", "cb0", "var<uniform>", "array<vec4<f32>, 1>", null, "uniform", 16], ["sampled-resource", "t0", "var<storage, read>", "array<u32>", null, "read-only-storage", 4], ["storage-resource", "u0", "var<storage, read_write>", "array<atomic<u32>>", null, "storage", 4]];
  if (bindings.length !== expected.length || expected.some(([kind, symbol, declaration, type, stride, bufferType, minSize], index) => {
    const binding = bindings[index];
    return binding?.resourceKind !== kind || binding.registerIndex !== 0 || binding.registerSpace !== 0 || binding.generatedSymbol !== symbol || binding.declaration !== declaration || binding.type !== type || (binding.structureStride ?? null) !== stride || binding.buffer?.type !== bufferType || binding.buffer.hasDynamicOffset !== false || binding.buffer.minBindingSize !== minSize;
  })) {
    throw new Error("WGSL merge-histograms compute binding layout does not match cb0/t0/u0");
  }
}
...
function rawSourcePart(operand, component) {
  ...
  throw new Error(`WGSL merge-histograms source ${operand.typeName || "unknown"} cannot be materialized`);
}
function sourceParts(instruction, operandIndex, active) {
  const operand = instruction.operands[operandIndex];
  return selectedComponents(operand, active).map(component => rawSourcePart(operand, component));
}
...
function aluStatement(instruction, constants) {
  if (instruction.opcodeName === "ftou") {
    ...
    return assignment(instruction, destination, components.map(component => `u32(${constants.generatedSymbol}[0u].${component})`));
  }
  if (instruction.opcodeName === "imul") {
    ...
    return assignment(instruction, destination, left.map((part, index) => `(${part} * ${right[index]})`));
  }
  const destination = instruction.operands[0];
  const active = Array.from(destination.mask);
  ...
  switch (instruction.opcodeName) {
    ...
    default:
      throw new Error(`WGSL merge-histograms ${instruction.opcodeName} instruction ${instruction.index} is not an ALU operation`);
  }
...
function typedLoad(instruction, input) {
  ...
  const parts = active.map((_, word) => `select(0u, ${input.generatedSymbol}[min(${safeBase} + ${word}u, ${length} - 1u)], ${address} < ${recordCount})`);
  return assignment(instruction, destination, parts);
}
...
function sharedLoad(instruction) {
  ...
  const byteOffset = sourceParts(instruction, 2, ["x"])[0];
  const index = `(${address} + (${byteOffset} >> 2u))`;
  return assignment(instruction, instruction.operands[0], [`atomicLoad(&g0[${index}])`]);
}
...
function lowerBody(program, bindings) {
  ...
  for (const instruction of program.instructions) {
    ...
    if (instruction.opcodeName === "endif") {
      ...
      if (owner?.kind !== "if") {
        throw new Error(`WGSL merge-histograms endif ${instruction.index} has malformed nesting`);
      }
    ...
    if (instruction.opcodeName === "endloop") {
      const owner = stack.pop();
      if (owner?.kind !== "loop") {
        throw new Error(`WGSL merge-histograms endloop ${instruction.index} has malformed nesting`);
      }
      current = owner.parent;
      continue;
    }
    ...
    if (instruction.opcodeName === "ret") {
      if (stack.length) {
        throw new Error(`WGSL merge-histograms return ${instruction.index} has malformed nesting`);
      }
      current.push({
        kind: "return",
        instructionIndex: instruction.index,
  ...
  if (stack.length) {
    throw new Error("WGSL merge-histograms compute contains unterminated control-flow nesting");
  }
  return statements;
}
 ...
 */
function lowerMergeHistogramsComputeProgram(program, options = {}) {
...
export { isMergeHistogramsComputeProfile, lowerMergeHistogramsComputeProgram };
//# sourceMappingURL=lowerMergeHistogramsComputeProgram.js.map
