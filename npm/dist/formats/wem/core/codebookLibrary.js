 ...
 */
function parseCodebookLibrary(bytes) {
 ...
 */
function rebuildCodebookById(library, id, writer) {
 ...
 * @param {object} writer OggPageWriter positioned inside the setup packet.
 */
function rebuildCodebook(reader, size, writer) {
...
export { bookMaptype1Quantvals, parseCodebookLibrary, rebuildCodebook, rebuildCodebookById };
//# sourceMappingURL=codebookLibrary.js.map
