...
class CjsSfxEngine {
  ...
  ContinueProgram(token, controls = {}) {
    ...
    const delayMs = token.node.continuous.transition === "delay" ? SampleRandomizedValue(token.node.continuous.transitionMs, token.node.continuous.transitionRangeMs, () => this.#SampleUnit()) : 0;
