  ...
  static [class Tr2ColorKey extends CjsModel {
    static {
      ({
        ...
        family: "incarna"
      })], [[[io, io.persist, type, type.string], 16, "name"], [[io, io.persist, type, type.float32], 16, "time"], [[io, io.persist, type, type.color], 16, "value"], [[io, io.persist, type, type.vec4], 16, "leftTangent"], [[io, io.persist, type, type.vec4], 16, "rightTangent"], [[io, io.persist, type, type.uint32, void 0, type.enum("Interpolation")], 16, "interpolation"]], 0, void 0, CjsModel));
    }
    constructor(...args) {
      super(...args);
