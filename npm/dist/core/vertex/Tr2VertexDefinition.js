import { Tr2RuntimeInstanceData as _Tr2RuntimeInstanceDa } from '../mesh/Tr2RuntimeInstanceData.js';

// Ported from CarbonEngine (MIT, (c) 2026 CCP Games) - https://github.com/carbonengine/trinity
//   trinity/trinityal/Tr2VertexDefinition.h:14-207 (the definition and its items)
...
class Tr2VertexDefinition {
  ...
  static UsageCode = _Tr2RuntimeInstanceDa.UsageCode;
  ...
  static isSameDefinition(first, second) {
    ...
    for (let index = 0; index < first.length; index++) {
      ...
      if (a.usage !== b.usage || a.usageIndex !== b.usageIndex || a.type !== b.type || a.offset !== b.offset || (a.stream ?? 0) !== (b.stream ?? 0) || (a.instanceStepRate ?? 0) !== (b.instanceStepRate ?? 0)) {
        return false;
      }
    }
    return true;
...
export { Tr2VertexDefinition };
//# sourceMappingURL=Tr2VertexDefinition.js.map
