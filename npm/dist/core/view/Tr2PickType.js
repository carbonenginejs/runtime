 ...
 * `TriBatchType` lives in `@carbonenginejs/runtime-utils/graphics`; this one
 ...
 */
const Tr2PickType = Object.freeze({
...
const TR2_PICK_TYPE_DEFAULT = Tr2PickType.PICK_TYPE_PICKING | Tr2PickType.PICK_TYPE_OPAQUE;

export { TR2_PICK_TYPE_DEFAULT, Tr2PickType };
//# sourceMappingURL=Tr2PickType.js.map
