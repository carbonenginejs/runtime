...
class CjsAudioBackendSfxProgramBatch {
  ...
  constructor(slot, overrides = {}) {
    ...
    this.id = String(overrides.id ?? selections?.[0]?.programBatchId ?? `${slot.id}:b${serial}`);
    this.actionTime = overrides.actionTime ?? slot.actionTime;
    this.selections = selections;
    this.selectionControllers = overrides.selectionControllers ?? slot.selectionControllers;
    this.cancelledSelectionKeys = overrides.cancelledSelectionKeys ?? slot.cancelledSelectionKeys;
    ...
    this.completionBarrier = overrides.completionBarrier ?? slot.completionBarrier;
    this.transitionDelayMs = overrides.transitionDelayMs ?? slot.transitionDelayMs;
...
export { CjsAudioBackendSfxProgramBatch, CjsAudioBackendSfxProgramSlot };
//# sourceMappingURL=CjsAudioBackendSfxProgramSlot.js.map
