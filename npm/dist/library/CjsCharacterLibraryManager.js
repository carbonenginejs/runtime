import { CjsCharacterLibrary as _CjsCharacterLibrary } from './CjsCharacterLibrary.js';
...
class CjsCharacterLibraryManager {
  ...
  async LoadLibraryAsync(filePath) {
    ...
    const operation = Promise.resolve().then(() => loader(path)).then(value => {
      if (!value) {
        return false;
      }
      const installed = PrepareLibrary(value);
...
export { CjsCharacterLibraryManager };
//# sourceMappingURL=CjsCharacterLibraryManager.js.map
