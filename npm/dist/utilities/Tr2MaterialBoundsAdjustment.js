...
let _initProto, _initClass, _init_maxLocalDisplacement, _init_extra_maxLocalDisplacement, _init_maxLocalScale, _init_extra_maxLocalScale, _init_rotatesVertices, _init_extra_rotatesVertices;
...
class Tr2MaterialBoundsAdjustment extends CjsModel {
  static {
    ({
      e: [_init_maxLocalDisplacement, _init_extra_maxLocalDisplacement, _init_maxLocalScale, _init_extra_maxLocalScale, _init_rotatesVertices, _init_extra_rotatesVertices, _initProto],
      c: [_Tr2MaterialBoundsAdj, _initClass]
    } = _applyDecs2311(this, [type.define({
      className: "Tr2MaterialBoundsAdjustment",
      family: "utilities"
    })], [[[type, type.float32], 16, "maxLocalDisplacement"], [[type, type.float32], 16, "maxLocalScale"], [[type, type.boolean], 16, "rotatesVertices"], [[carbon, carbon.method, impl, impl.implemented], 18, "AdjustBounds"]], 0, void 0, CjsModel));
  }
  constructor(...args) {
    super(...args);
  ...
  maxLocalDisplacement = (_initProto(this), _init_maxLocalDisplacement(this, 0));
