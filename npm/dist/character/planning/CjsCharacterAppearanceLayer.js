...
class CjsCharacterAppearanceLayer extends CjsModel {
  static {
    ({
      e: [_init_owner, _init_extra_owner, _init_contributor, _init_extra_contributor, _init_origin, _init_extra_origin],
      c: [_CjsCharacterAppearan, _initClass]
    } = _applyDecs2311(this, [type.define({
      className: "CjsCharacterAppearanceLayer",
      family: "character"
    })], [[[io, io.readwrite, void 0, type.model("CjsCharacterAppearanceSelection")], 16, "owner"], [[io, io.readwrite, void 0, type.model("CjsCharacterResolvedPart")], 16, "contributor"], [[io, io.readwrite, void 0, type.model("CjsCharacterOrigin")], 16, "origin"]], 0, void 0, CjsModel));
  }
  constructor(...args) {
    super(...args);
  ...
  origin = (_init_extra_contributor(this), _init_origin(this, null));
  static {
    _initClass();
  }
}
