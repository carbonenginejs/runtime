...
new class extends _identity {
  static [class EveTurretSetPSData extends CjsModel {
    static {
      ({
      ...
      })], [[[type, type.vec4], 16, "shipData"], [[type, type.vec4], 16, "clipData1"], [[type, type.float32], 16, "clipRadius2Sq"], [[type, type.vec3], 16, "unused"], [type.array("vec4"), 0, "shLightingCoefficients"]], 0, void 0, CjsModel));
    }
    constructor(...args) {
      super(...args);
    ...
    shLightingCoefficients = (_init_extra_unused(this), _init_shLightingCoefficients(this, Array.from({
      length: _EveTurretSetPSData.SH_COEFFICIENT_COUNT
    }, () => vec4.create())));
  ...
  constructor() {
    super(_EveTurretSetPSData), _initClass();
  }
}();
