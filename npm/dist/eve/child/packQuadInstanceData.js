 ...
 */
function packQuadInstanceData(record, out = new Uint8Array(QUAD_INSTANCE_SIZE)) {
  ...
  let byteOffset = 0;
  for (const values of [record.parentTransform0, record.parentTransform1, record.parentTransform2, record.localTransform0, record.localTransform1, record.localTransform2]) {
  ...
  return out.byteLength === QUAD_INSTANCE_SIZE ? out : out.subarray(0, QUAD_INSTANCE_SIZE);
}

export { QUAD_INSTANCE_SIZE, packQuadInstanceData };
//# sourceMappingURL=packQuadInstanceData.js.map
