...
new class extends _identity {
  static [class EveEffectRoot2 extends _EveEntity {
    ...
    GetPerObjectStructs(vsData = RawData.create("EveSpaceObjectVSData"), psData = RawData.create("EveSpaceObjectPSData")) {
      vsData.Zero();
      psData.Zero();
      vsData.Set("shipData", _EveEffectRoot.#neutralShipData);
      psData.Set("shipData", _EveEffectRoot.#neutralShipData);
      return {
        vs: vsData,
        ps: psData
      };
  ...
  #neutralShipData = Object.freeze([0, 1, 0, 1]);
