...
import { buildMatrixPipelines } from "../../../test/trinityal/webgpu/harness/support/matrixPipelines.js";
import { validateDecalCounterV5PackagePair } from "../../../test/trinityal/webgpu/harness/decalCounterV5Fixture.js";
import { validateDecalCylindricV5PackagePair } from "../../../test/trinityal/webgpu/harness/decalCylindricV5Fixture.js";
import { validateDecalGlowCylindricV5PackagePair } from "../../../test/trinityal/webgpu/harness/decalGlowCylindricV5Fixture.js";
import { validateDecalGlowV5PackagePair } from "../../../test/trinityal/webgpu/harness/decalGlowV5Fixture.js";
import { validateDecalHoleV5PackagePair } from "../../../test/trinityal/webgpu/harness/decalHoleV5Fixture.js";
import { validateDecalV5PackagePair } from "../../../test/trinityal/webgpu/harness/decalV5Fixture.js";
import { validateQuadDetailV5PackagePair } from "../../../test/trinityal/webgpu/harness/quadDetailV5Fixture.js";
import { validateQuadGlassV5PackagePair } from "../../../test/trinityal/webgpu/harness/quadGlassV5Fixture.js";
import { validateQuadHeatV5PackagePair } from "../../../test/trinityal/webgpu/harness/quadHeatV5Fixture.js";
import { validateQuadOilV5PackagePair } from "../../../test/trinityal/webgpu/harness/quadOilV5Fixture.js";
import { validateQuadSailsV5PackagePair } from "../../../test/trinityal/webgpu/harness/quadSailsV5Fixture.js";
import { validateQuadV5PackagePair } from "../../../test/trinityal/webgpu/harness/quadV5Fixture.js";
...
async function ReadPackagePipeline(path)
{
    const [ { CjsWebgpuFormat }, { CjsWebgpuPackage }, { buildCopyblitDrawDescriptor } ] = await Promise.all([
        ...
        import("#trinityal/webgpu"),
        import("../../../test/trinityal/webgpu/harness/support/packageDraw.js")
    ]);
...
async function ReadBodySetPrepare(path)
{
    const [ { CjsWebgpuFormat }, { CjsWebgpuPackage }, { buildBodySetPipelines } ] = await Promise.all([
        import("#resource/formats/webgpu"),
        import("#trinityal/webgpu"),
        import("../../../test/trinityal/webgpu/harness/support/bodySetPipelines.js")
    ]);
...
const RUNTIME_BOUNDARY_PATH = new URL(
    "../../../.cache/trinityal/webgpu/harness-runtime.js",
    import.meta.url
);
...
const ASSETS = new Map([
    [ "/", { path: new URL("../../../test/trinityal/webgpu/harness/index.html", import.meta.url), type: "text/html; charset=utf-8" } ],
    [ "/index.html", { path: new URL("../../../test/trinityal/webgpu/harness/index.html", import.meta.url), type: "text/html; charset=utf-8" } ],
    [ "/run.js", { path: new URL("../../../test/trinityal/webgpu/harness/run.js", import.meta.url), type: "text/javascript; charset=utf-8" } ],
    [ "/computePipeline.js", { path: new URL("../../../test/trinityal/webgpu/harness/computePipeline.js", import.meta.url), type: "text/javascript; charset=utf-8" } ],
    [ "/runtimeBoundary.js", { body: RUNTIME_BOUNDARY, type: "text/javascript; charset=utf-8" } ],
    [ "/decalCounterV5Fixture.js", { path: new URL("../../../test/trinityal/webgpu/harness/decalCounterV5Fixture.js", import.meta.url), type: "text/javascript; charset=utf-8" } ],
    [ "/decalCylindricV5Fixture.js", { path: new URL("../../../test/trinityal/webgpu/harness/decalCylindricV5Fixture.js", import.meta.url), type: "text/javascript; charset=utf-8" } ],
    [ "/decalGlowCylindricV5Fixture.js", { path: new URL("../../../test/trinityal/webgpu/harness/decalGlowCylindricV5Fixture.js", import.meta.url), type: "text/javascript; charset=utf-8" } ],
    [ "/decalGlowV5Fixture.js", { path: new URL("../../../test/trinityal/webgpu/harness/decalGlowV5Fixture.js", import.meta.url), type: "text/javascript; charset=utf-8" } ],
    [ "/decalHoleV5Fixture.js", { path: new URL("../../../test/trinityal/webgpu/harness/decalHoleV5Fixture.js", import.meta.url), type: "text/javascript; charset=utf-8" } ],
    [ "/decalV5Fixture.js", { path: new URL("../../../test/trinityal/webgpu/harness/decalV5Fixture.js", import.meta.url), type: "text/javascript; charset=utf-8" } ],
    [ "/quadGlassV5Fixture.js", { path: new URL("../../../test/trinityal/webgpu/harness/quadGlassV5Fixture.js", import.meta.url), type: "text/javascript; charset=utf-8" } ],
    [ "/quadHeatV5Fixture.js", { path: new URL("../../../test/trinityal/webgpu/harness/quadHeatV5Fixture.js", import.meta.url), type: "text/javascript; charset=utf-8" } ],
    [ "/quadDetailV5Fixture.js", { path: new URL("../../../test/trinityal/webgpu/harness/quadDetailV5Fixture.js", import.meta.url), type: "text/javascript; charset=utf-8" } ],
    [ "/quadOilV5Fixture.js", { path: new URL("../../../test/trinityal/webgpu/harness/quadOilV5Fixture.js", import.meta.url), type: "text/javascript; charset=utf-8" } ],
    [ "/quadSailsV5Fixture.js", { path: new URL("../../../test/trinityal/webgpu/harness/quadSailsV5Fixture.js", import.meta.url), type: "text/javascript; charset=utf-8" } ],
    [ "/quadV5Fixture.js", { path: new URL("../../../test/trinityal/webgpu/harness/quadV5Fixture.js", import.meta.url), type: "text/javascript; charset=utf-8" } ],
    [ "/config.json", {
        body: JSON.stringify({
