...
const ACCEPTED = new Map([
    ...
    [ "CjsWebgpuTextureAL.GetSRGBViewMetalTexture",
        "Metal's sRGB view accessor; ours is GetDeviceTextureView(dimension, colorSpace), which answers both spaces. Recorded in CjsWebgpuTextureAL.js." ],
    [ "CjsWebgpuTextureAL.GetUAVMetalTexture",
        "Metal's per-mip UAV view; this backend binds no storage textures (SUPPORTS_UNORDERED_ACCESS is false in CjsWebgpuCapsAL.js)." ],
    [ "CjsWebgpuTextureAL.AssignFromTexture",
        "Metal-only adoption of a foreign MTLTexture (the drawable); the swap chain owns the canvas texture here and no Tr2TextureAL wraps it." ],
