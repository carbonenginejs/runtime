...
for (const file of files)
{
  ...
  if (!includeDropped && relativeFile.startsWith("src/trinity/dropped/")) continue;
...
function CreateRecord(file, className, member, line)
{
  ...
  const bucket = parts[2] === "generated" ? "generated" : parts[2] === "dropped" ? "dropped" : "maintained";
  const family = bucket === "generated" ? parts[3] : parts[2];
