...
import { buildMatrixPipelines } from "../../../test/engine/webgpu/harness/support/matrixPipelines.js";
import { validateDecalCounterV5PackagePair } from "../../../test/engine/webgpu/harness/decalCounterV5Fixture.js";
import { validateDecalCylindricV5PackagePair } from "../../../test/engine/webgpu/harness/decalCylindricV5Fixture.js";
import { validateDecalGlowCylindricV5PackagePair } from "../../../test/engine/webgpu/harness/decalGlowCylindricV5Fixture.js";
import { validateDecalGlowV5PackagePair } from "../../../test/engine/webgpu/harness/decalGlowV5Fixture.js";
import { validateDecalHoleV5PackagePair } from "../../../test/engine/webgpu/harness/decalHoleV5Fixture.js";
import { validateDecalV5PackagePair } from "../../../test/engine/webgpu/harness/decalV5Fixture.js";
import { validateQuadDetailV5PackagePair } from "../../../test/engine/webgpu/harness/quadDetailV5Fixture.js";
import { validateQuadGlassV5PackagePair } from "../../../test/engine/webgpu/harness/quadGlassV5Fixture.js";
import { validateQuadHeatV5PackagePair } from "../../../test/engine/webgpu/harness/quadHeatV5Fixture.js";
import { validateQuadOilV5PackagePair } from "../../../test/engine/webgpu/harness/quadOilV5Fixture.js";
import { validateQuadSailsV5PackagePair } from "../../../test/engine/webgpu/harness/quadSailsV5Fixture.js";
import { validateQuadV5PackagePair } from "../../../test/engine/webgpu/harness/quadV5Fixture.js";
...
async function ReadPackagePipeline(path)
{
    const [ { CjsWebgpuFormat }, { CjsWebgpuPackage }, { buildCopyblitDrawDescriptor } ] = await Promise.all([
        ...
        import("../../../test/engine/webgpu/harness/support/packageDraw.js")
    ]);
...
async function ReadBodySetPrepare(path)
{
    const [ { CjsWebgpuFormat }, { CjsWebgpuPackage }, { buildBodySetPipelines } ] = await Promise.all([
        import("#resource/formats/webgpu"),
        import("#engine/webgpu"),
        import("../../../test/engine/webgpu/harness/support/bodySetPipelines.js")
    ]);
...
const ASSETS = new Map([
    ...
    [ "/decalGlowV5Fixture.js", { path: new URL("../../../test/engine/webgpu/harness/decalGlowV5Fixture.js", import.meta.url), type: "text/javascript; charset=utf-8" } ],
    [ "/decalHoleV5Fixture.js", { path: new URL("../../../test/engine/webgpu/harness/decalHoleV5Fixture.js", import.meta.url), type: "text/javascript; charset=utf-8" } ],
    [ "/decalV5Fixture.js", { path: new URL("../../../test/engine/webgpu/harness/decalV5Fixture.js", import.meta.url), type: "text/javascript; charset=utf-8" } ],
    [ "/quadGlassV5Fixture.js", { path: new URL("../../../test/engine/webgpu/harness/quadGlassV5Fixture.js", import.meta.url), type: "text/javascript; charset=utf-8" } ],
    [ "/quadHeatV5Fixture.js", { path: new URL("../../../test/engine/webgpu/harness/quadHeatV5Fixture.js", import.meta.url), type: "text/javascript; charset=utf-8" } ],
    [ "/quadDetailV5Fixture.js", { path: new URL("../../../test/engine/webgpu/harness/quadDetailV5Fixture.js", import.meta.url), type: "text/javascript; charset=utf-8" } ],
